			...
			<form id="form-login" class="login100-form validate-form">
              ...
              <div class="card-body">
			   ...
			   <div class="row mt-3">
                  ...
                  <center> 
                  <p class="text-muted">Aplikasi Database ini mencakup: Database siswa,Database guru, Alumni, PPDB Online dan Administrasi Mutasi</p> <a href="<?= $link ?>" target="_rdmlink"><?= $create ?></a><center> Versi <b> <?= $versi ?></b></center></center>
              </div>
...
<script>
    $('#form-login').submit(function(e) {
      ...
      $.ajax({
        type: 'POST',
        url: 'login_cek.php?id=apmbaenasliwongjawa',
        data: $(this).serialize(),
      ...
      return false;
            ...
            <div class="login100-more" style="background-image: url('../assets/back/bg-login.png?1.0.3');height: 100vh;position: absolute;top: 0px;left: 0px;">
            </div>
        </div>
    </div>
</div>
