...
<?php if ($setting['_kop'] == "1") { ?>
 <table width="100%" class="page_header1" >
    <tbody><tr>
        ...
        <td>
            <center><img src="<?= $url ?>/<?= $setting['kop'] ?> " width="100%">
            </center></td>
...
<?php } else { ?>
    <table width="100%" class="page_header1" >
    <tbody><tr>
        <td style="width:75px;padding-bottom:4px;"><img src="<?= $url ?>/<?= $setting['logo'] ?> " height="75px"></td>
        <td>
            <center>
			   ...
			   <br>
                ...
                <tr>
                    <td colspan="5" width="30%" valign="left" style="font-size:11.0pt;">
							...
							<li>PC Akte Kelahiran 2 Lembar</li>
							<li>PC Kartu Keluarga 2 Lembar</li>
					...
					<td colspan="3" width="10%" valign="bottom">
                        ...
                        <div  style=" display:inline-block;float: right;width: 27mm;">
                         ...
                         <?php if ($siswa['foto'] == "") { ?> 
						 <img class="img" src="<?= $url ?>/assets/img/avatar/avatar-1.png" ec="H" style="width: 30mm; background-color: white; color: black;">
						 <?php } else { ?>  	
