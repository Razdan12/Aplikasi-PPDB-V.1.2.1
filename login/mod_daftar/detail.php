        ...
        <div class="card author-box card-primary">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a target="_blank" href="mod_daftar/print_daftar.php?id=<?= $_GET['id'] ?>" type="button" class="btn btn-success"><i class="fa fa-print    "></i> Cetak Form</a>
                    <a target="_blank" href="mod_daftar/pernyataan.php?id=<?= $_GET['id'] ?>" type="button" class="btn btn-success"><i class="fa fa-print    "></i> Surat Pernyataan</a>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="author-box-details">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab3" data-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-user    "></i> Data Diri</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab3" data-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-user-friends    "></i> Orang Tua</a>
                        </li>
                     <!--   <li class="nav-item">
                            <a class="nav-link" id="contact-tab3" data-toggle="tab" href="#contact3" role="tab" aria-controls="contact" aria-selected="false"><i class="fa fa-history    "></i> Histori</a>
                        </li> -->
                    </ul>
                        ...
                        <div class="tab-pane fade" id="profile3" role="tabpanel" aria-labelledby="profile-tab3">
                            <div class="table-responsiv">
                                <table class="table table-striped table-sm ">
                                    <tbody>
                                        <tr>
                                            <td align="center" colspan="2"><i class="fa fa-user-friends"></i> <b>Data Lengkap Ayah</b></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>NIK Ayah</b></td>
                                            <td align="left"><i class="fa fa-id-card text-success"></i> <?= $siswa['nik_ayah'] ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- DATA LENGKAP IBU -->
                                        <tr>
                                            <td align="center" colspan="2"><i class="fa fa-user-friends"></i> <b>Data Lengkap Ibu</b></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>NIK Ibu</b></td>
                                            <td align="left"><i class="fa fa-id-card text-success"></i> <?= $siswa['nik_ibu'] ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <!-- DATA LENGKAP WALI -->
                                        <tr>
                                            <td align="center" colspan="2"><i class="fa fa-user-friends"></i> <b>Data Lengkap Wali</b></td>
                                        </tr>
                                        <tr>
                                            <td align="right"><b>NIK Wali</b></td>
                                            <td align="left"><i class="fa fa-id-card text-success"></i> <?= $siswa['nik_wali'] ?></td>
                                        </tr>
                                        <tr>
                    ...
                    <div class="float-right mt-sm-0 mt-3">
                        <a id="profile-tab3" data-toggle="tab" href="#profile3">View Posts <i class="fa fa-chevron-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
