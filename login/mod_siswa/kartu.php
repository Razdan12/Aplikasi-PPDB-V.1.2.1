...
<div class="fade-in ng-scope" ui-view="">         <div class="container-fluid ng-scope">
            <div class="fade-in">
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <!-- ngIf: datakelasSelect.jurusan_nama!=='' --><h4 ng-if="datakelasSelect.jurusan_nama!==''" ng-bind="datakelasSelect.tingkat_nama +'.'+datakelasSelect.jurusan_nama+'.'+ datakelasSelect.kelas_nama" class="ng-binding ng-scope">XI.IPS.1</h4><!-- end ngIf: datakelasSelect.jurusan_nama!=='' -->
                        <p class="text-muted font-size-sm mb-0">Wali Kelas</p>
                      <p class="text-muted font-size-sm font-weight-bold ng-binding" ng-bind="''+datakelasSelect.walas_nama+''">SRI WAHYUDIANI, S.Pd</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-3">
               ...
               <ul class="list-group list-group-flush">
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span class="text-primary ng-binding" ng-bind="datakelasSelect.mapel_nama">Bahasa Indonesia</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-0">
                    ...
                    Jumlah Siswa</h6>
                    <span class="text-primary ng-binding" ng-bind="datakelasSelect.jum_siswa">8</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-0">
                    ...
                    Tahun Ajaran</h6>
                    <span class="text-primary ng-binding" ng-bind="datakelasSelect.tahunajaran_id+'/'+((datakelasSelect.tahunajaran_id*1)+1)">2021/2022</span>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    <h6 class="mb-0">
                    ...
                    Semester</h6>
                    <!-- ngIf: datakelasSelect.semester_id == '1' --><span ng-if="datakelasSelect.semester_id == '1'" class="text-primary ng-scope">Ganjil</span><!-- end ngIf: datakelasSelect.semester_id == '1' -->
                    <!-- ngIf: datakelasSelect.semester_id == '2' -->
                  </li>
