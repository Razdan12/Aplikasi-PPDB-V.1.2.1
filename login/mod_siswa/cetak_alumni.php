...
Kosong
<?php } else { ?>
<?php $siswaq= fetch($koneksi, 'siswa', ['tahun_lulus' => $_GET['tahun']]) ?>
...
<HTML>
<HEAD>
    <title>Buku induk siswa kelas <?= $siswaq['tahun_lulus'] ?></title>
    ...
    <tr>
        <td>
            ...
            <div align="center" class="style13">
                    <b>DATA ALUMNI TAHUN <?= $siswaq['tahun_lulus'] ?></b>
            </div>
            <br>
            ...
            <table width="100%" border="0">
                <?php
                            $query = mysqli_query($koneksi, "select * from siswa where tahun_lulus='$siswaq[tahun_lulus]'");
                ...
                <tr>
                    ...
                    <table width="100%" border="0">
                        ...
                        <tr>
                        <td width="20%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> Jenis Kelamin </td>
                        <td width="1%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> : </td>
                        <td width="75%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> <?php if ($siswa['jk'] == 'L') { ?> Laki Laki <?php } else { ?> Perempuan <?php } ?> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td width="20%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> No Belangko</td>
                            <td width="1%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> : </td>
                            <td width="75%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> <?= $siswa['no_ijazahalumni'] ?> </td>
                        </tr>
                        <tr>
                        <td width="20%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> Tahun Lulus </td>
                        <td width="1%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> : </td>
                        <td width="75%" valign="top" style='font-size:11.0pt;padding-left: 40px;'> <?= $siswa['tahun_lulus'] ?> </td>
                        </tr>
