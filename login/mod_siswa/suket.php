    ...
    <tr>
        <td>
            ...
            <div align="center" class="style13">
                    &nbsp;<b>   SURAT KETERANGAN AKTIF   </b>&nbsp;
					 <p>No. Surat :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Suket/MA/NW/<?= date('Y') ?><p>
            </div>
            <br>
...
<table width="100%" border="0">
			...
			<td style='font-size:12.0pt;padding-left: 5px;line-height: 28px;'>
                    ...
                    Bahwa benar siswa tersebut diatas merupakan siswa aktif di Sekolah/Madrasah <b><?= $setting['nama_sekolah'] ?></b> Kecamatan <?= $setting['kec'] ?> Kabupaten <?= $setting['kota'] ?> pada tahun ajaran <?= date('Y') ?>/<?= $tahun2 ?>
                    <br>
					</br>
					Demikian surat keterangan ini dibuat untuk dipergunakan sebagaimana mestinya.</td>
